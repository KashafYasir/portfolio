...
const Footer = () => {
  return (
    <div className='bg-gray-200'    ><footer className="text-gray-800 body-font">
    <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <p className="text-sm text-gray-800 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2024 WEb Developer —
        <a href="kashafyasir21@gmail.com" className="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@kashafali</a>
      </p>
